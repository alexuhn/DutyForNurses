...
- [잘못된 간호사 듀티표가 간호사들의 삶의 질에 미치는 영향](https://m.khan.co.kr/view.html?art_id=202105220907011)
...
- **삶의 질을 개선하며**: 휴일, 이전 달 근무, 나이 및 연차 등을 고려한  **인간적이며 상식적인** 스케쥴을 제작하는 알고리즘입니다.
- 클릭 1~ 2회 내에 시간표 생성, 수정,  휴가 신청 등이 가능합니다.
- 빠른 스케쥴 제작 속도(평균 7ms)를 보여줍니다.
- 개인별 시간표를 달력 형태를 제공합니다.
